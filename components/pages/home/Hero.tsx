...
<section className="relative w-full min-h-screen flex flex-col justify-start pb-10">
  ...
  <div className="relative z-20 flex flex-col items-center justify-center text-center px-4 md:px-8 pt-40 md:pt-60">
    <motion.h1
      ...
      className="text-white text-2xl sm:text-3xl md:text-5xl font-normal mb-4 md:mb-6 leading-snug"
    >
    ...
    <motion.p
      ...
      whileInView={{ opacity: 1, scale: 1 }}
      transition={{ duration: 0.8, delay: 0.3 }}
      className="text-white/80 text-sm sm:text-base md:text-lg mb-6 md:mb-8 max-w-xl leading-relaxed"
    >
      Pelet ikan, pakan ayam, dan ternak dari limbah agro-maritim.
      Hemat hingga 30%! Beli pakan, bantu bumi.
    </motion.p>
