...
export default function CartPage() {
  ...
  // Redirect if not authenticated (this will be handled by useEffect, but show loading meanwhile)
  if (!user) {
    return (
      <div className="min-h-screen pt-20 md:pt-32 pb-16 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mt-4">Mengalihkan ke halaman login...</p>
        </div>
      </div>
    );
  }
